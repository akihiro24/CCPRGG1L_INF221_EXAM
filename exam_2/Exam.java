...
public class Exam {
    ...
    public static void main(String[] args) throws Exception {
        ...
        int studentNumber1 = toLast6(studentNumber);
        System.out.println("The last 6 digits of your student number is: " + studentNumber1);
        ...
        if (studentEmailAddress.contains("delavina")){
            System.out.println("Valid!");
        } else {
            System.out.println("Invalid!");
        }
